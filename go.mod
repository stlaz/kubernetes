...
require (
	...
	github.com/openshift/apiserver-library-go v0.0.0-20230202032534-198c4a03c8df
...
replace (
	...
	github.com/openshift/apiserver-library-go => github.com/openshift/apiserver-library-go v0.0.0-20230202032534-198c4a03c8df
