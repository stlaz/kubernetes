...
require (
	...
	github.com/openshift/apiserver-library-go v0.0.0-20230707094550-98463b84307e
...
replace (
	...
	github.com/openshift/apiserver-library-go => github.com/openshift/apiserver-library-go v0.0.0-20230707094550-98463b84307e
