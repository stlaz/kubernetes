...
type ClusterTrustBundleInformer interface {
	...
	Lister() v1beta1.ClusterTrustBundleLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CertificatesV1beta1().ClusterTrustBundles().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CertificatesV1beta1().ClusterTrustBundles().Watch(context.TODO(), options)
			},
		},
...
func (f *clusterTrustBundleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&certificatesv1beta1.ClusterTrustBundle{}, f.defaultInformer)
}

func (f *clusterTrustBundleInformer) Lister() v1beta1.ClusterTrustBundleLister {
	return v1beta1.NewClusterTrustBundleLister(f.Informer().GetIndexer())
}
