...
type ClusterTrustBundleLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.ClusterTrustBundle, err error)
	// Get retrieves the ClusterTrustBundle from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1beta1.ClusterTrustBundle, error)
...
type clusterTrustBundleLister struct {
	listers.ResourceIndexer[*v1beta1.ClusterTrustBundle]
}
...
func NewClusterTrustBundleLister(indexer cache.Indexer) ClusterTrustBundleLister {
	return &clusterTrustBundleLister{listers.New[*v1beta1.ClusterTrustBundle](indexer, v1beta1.Resource("clustertrustbundle"))}
}
